...
export default function Register() {
  ...
  const handleRegister = async (e: React.FormEvent) => {
    ...
    if (passwordStrength.score <= 2) {
      setError("Password is too weak. Please use at least 8 characters with numbers, uppercase and lowercase letters.");
      setLoading(false);
      return;
    }
      ...
      <div className="hidden lg:flex flex-col w-1/2 relative overflow-hidden"
        ...
        <div className="absolute bottom-0 left-0 right-0" style={{height: '280px'}}>
          <svg viewBox="0 0 500 280" fill="none" xmlns="http://www.w3.org/2000/svg"
            ...
            <ellipse cx="250" cy="250" rx="180" ry="40" fill="url(#rg-floor-glow)"/>

            {/* Vertical light beam from book center */}
            <ellipse cx="250" cy="155" rx="38" ry="130" fill="url(#rg-book-glow)"/>
