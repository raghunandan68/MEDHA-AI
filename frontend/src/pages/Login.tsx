      ...
      <div className="hidden lg:flex flex-col w-1/2 relative overflow-hidden"
        ...
        <div className="absolute bottom-0 left-0 right-0" style={{height: '280px'}}>
          <svg viewBox="0 0 500 280" fill="none" xmlns="http://www.w3.org/2000/svg"
            ...
            <defs>
              <radialGradient id="lg-book-glow" cx="50%" cy="55%" r="45%">
                <stop offset="0%" stopColor="#c4b5fd" stopOpacity="0.95"/>
                <stop offset="25%" stopColor="#8b5cf6" stopOpacity="0.55"/>
                <stop offset="60%" stopColor="#4c1d95" stopOpacity="0.20"/>
                <stop offset="100%" stopColor="#4c1d95" stopOpacity="0"/>
              </radialGradient>
              <radialGradient id="lg-floor-glow" cx="50%" cy="50%" r="50%">
                <stop offset="0%" stopColor="#7c3aed" stopOpacity="0.45"/>
                <stop offset="100%" stopColor="#4c1d95" stopOpacity="0"/>
              </radialGradient>
              <filter id="lg-blur-card">
                <feGaussianBlur stdDeviation="2"/>
              </filter>
            </defs>

            {/* Floor glow under book */}
            <ellipse cx="250" cy="250" rx="180" ry="40" fill="url(#lg-floor-glow)"/>

            {/* Vertical light beam from book center */}
            <ellipse cx="250" cy="155" rx="38" ry="130" fill="url(#lg-book-glow)"/>
      ...
      <div className="flex-1 flex items-center justify-center p-8 relative">
        ...
        <div className="w-full max-w-md bg-medha-card rounded-2xl p-8 shadow-2xl relative z-10 border border-violet-500/20">
          ...
          <div className="flex border-b border-white/5 mb-8">
            <button className="flex-1 pb-3 text-sm font-semibold border-b-2 border-violet-500 text-white">Login</button>
            <Link to="/register" className="flex-1 pb-3 text-sm font-medium text-slate-400 text-center hover:text-slate-200">Sign Up</Link>
          </div>
          ...
          <form onSubmit={handleLogin} className="space-y-5">
            <div>
              ...
              <div className="flex justify-between items-center mb-2">
                ...
                <Link to="/forgot-password" className="text-xs text-violet-400 hover:underline">Forgot password?</Link>
              </div>
          ...
          <p className="mt-6 text-center text-xs text-slate-500">
            New here?{" "}
            <Link to="/register" className="font-bold text-violet-400 hover:text-violet-300">
              Sign up
            </Link>
          </p>
